...
PAIR_TESTS = [
    ...
    PairTest('11101X1111', '10111X1111', np.inf, np.inf, 2, 2), # expected distance 2 for symmetric metric
    PairTest('33233X1111', '00000X1111', 3, 3, 3, 3),
    PairTest('1111111111X1111111111', '2212222222X2222222222', 2, 3, 2, 3),
    PairTest('2222222222X2222222222', '3323333333X3333323333', 3, 4, 3, 4),
    PairTest('1111111X11X11X1111X1111', '3322112X22X23X2222X2200', 5, 9, 5, 9),
    PairTest('1111111111X111X111', '3332222221X333X333', 4, 6, 4, 6),
]
