...
with open('../Figures_Kaufmann_et_al_2021/final_figures/method_example_fst_gainloss.pdf', 'wb') as f:
    f.write(fst_to_pdf(XX, ranksep=0.25, nodesep=0.1, fontsize=12))
with open('../Figures_Kaufmann_et_al_2021/final_figures/method_example_fst_loh.pdf', 'wb') as f:
    f.write(fst_to_pdf(LOH, fontsize=12))
with open('../Figures_Kaufmann_et_al_2021/final_figures/method_example_fst_wgd.pdf', 'wb') as f:
    f.write(fst_to_pdf(W1step, fontsize=12))
with open('../Figures_Kaufmann_et_al_2021/final_figures/method_example_fsa1.pdf', 'wb') as f:
    f.write(fst_to_pdf(g1, acceptor=True, fontsize=10))
with open('../Figures_Kaufmann_et_al_2021/final_figures/method_example_fsa2.pdf', 'wb') as f:
    f.write(fst_to_pdf(g2, acceptor=True, fontsize=10))
with open('../Figures_Kaufmann_et_al_2021/final_figures/method_example_composition.pdf', 'wb') as f:
    f.write(fst_to_pdf(U, fontsize=12))
with open('../Figures_Kaufmann_et_al_2021/final_figures/method_example_simple_fst.pdf', 'wb') as f:
