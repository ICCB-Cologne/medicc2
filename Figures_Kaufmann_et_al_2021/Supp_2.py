...
fig_main.savefig('final_figures/Supp_2A.pdf', bbox_inches='tight')
fig_main.savefig('final_figures/Supp_2A.png', bbox_inches='tight', dpi=600)

fig_main = plot_variables(results, ('nevents', 'dist_fst_no_wgd_asymm'))
fig_main.savefig('final_figures/Supp_2B.pdf', bbox_inches='tight')
fig_main.savefig('final_figures/Supp_2B.png', bbox_inches='tight', dpi=600)

fig_main = plot_variables(results, ('nevents', 'dist_euclidean'))
fig_main.savefig('final_figures/Supp_2C.pdf', bbox_inches='tight')
fig_main.savefig('final_figures/Supp_2C.png', bbox_inches='tight', dpi=600)
